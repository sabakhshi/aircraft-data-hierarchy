...
from aircraft_data_hierarchy.behavior import UngriddedTableDef, Description, DataPoint
...
def daveml_viewer(prob, pt, prop, firstPass=True, file=sys.stdout):
    """
    print a report of all the relevant cycle properties
    """
    ...
    if (firstPass):
        engine_deck = UngriddedTableDef(
            name="Engine Deck",
            ut_id="Engine_deck",
            units="lbf",
            description=Description(value="Engine deck ungridded table example"),
            data_point=[
                DataPoint(value="%7.5f  %7.1f %7.3f %7.1f %7.1f %7.1f %7.3f  %7.5f  %7.3f" %summary_data)
            ]
        )
        prop.temp_behavior.gridded_table_def = engine_deck
    else:
        prop.temp_behavior.gridded_table_def.data_point.append(DataPoint(value="%7.5f  %7.1f %7.3f %7.1f %7.1f %7.1f %7.3f  %7.5f  %7.3f" %summary_data))
